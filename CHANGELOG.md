...
- Core dependencies: `actix-web`, `actix-files`, `serde_json`, `askama`, `serde`
- Nix flake support for reproducible development environments.
- MIT License.
- README and project documentation.

[Unreleased]: https://github.com/santoshxshrestha/rusre/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/santoshxshrestha/rusre/releases/tag/v0.2.0
[0.1.0]: https://github.com/santoshxshrestha/rusre/releases/tag/v0.1.0
